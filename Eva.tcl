...
set uw(serv) eva.yournetwork.org
# Server info line
set uw(sinfo) "I see everything"
# The name of the server that will host Eva
set uw(rserv) Hub.server.link

# This info must match the connect block on your ircd
#server's ip
set uw(link) 69.69.69.69
#server connect port
set uw(port) 4400
#connect block password
set uw(pass) serverpasswd
...
set uw(nick) EVA
set uw(host) myhost.org
set uw(ident) service
